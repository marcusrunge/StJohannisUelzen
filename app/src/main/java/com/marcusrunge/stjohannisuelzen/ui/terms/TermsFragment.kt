...
/**
 * A [Fragment] to display the terms of use of the app.
 * It uses data binding to connect the layout with the [TermsViewModel].
 */
@AndroidEntryPoint
class TermsFragment : Fragment() {
    ...
    /**
     * The [TermsViewModel] for this fragment, scoped to the fragment's lifecycle.
     * It is used to provide data to the UI.
     */
    ...
    override fun onCreateView(
        ...
        _binding = DataBindingUtil.inflate(inflater, R.layout.terms_fragment, container, false)
        return binding.root
    }
